...
-- Restaurants
INSERT INTO restaurant (id, name, delivery_fee, kitchen_id, registered_date, last_updated_date, address_city_id, address_postcode, address_street, address_number, address_district)
VALUES (1, 'Thai Gourmet', 10, 1, UTC_TIMESTAMP, UTC_TIMESTAMP, 1, '38400-999', 'João Pinheiro Street', '1000', 'Downtown');

INSERT INTO restaurant (id, name, delivery_fee, kitchen_id, registered_date, last_updated_date)
VALUES (2, 'Thai Delivery', 9.50, 1, UTC_TIMESTAMP, UTC_TIMESTAMP);

INSERT INTO restaurant (id, name, delivery_fee, kitchen_id, registered_date, last_updated_date)
VALUES (3, 'Tuk Tuk Indian Food', 15, 2, UTC_TIMESTAMP, UTC_TIMESTAMP);

INSERT INTO restaurant (id, name, delivery_fee, kitchen_id, registered_date, last_updated_date)
VALUES (4, 'Java Steakhouse', 12, 3, UTC_TIMESTAMP, UTC_TIMESTAMP);

INSERT INTO restaurant (id, name, delivery_fee, kitchen_id, registered_date, last_updated_date)
VALUES (5, 'Uncle Sam Snack Bar', 11, 4, UTC_TIMESTAMP, UTC_TIMESTAMP);

INSERT INTO restaurant (id, name, delivery_fee, kitchen_id, registered_date, last_updated_date)
VALUES (6, 'Maria’s Bar', 6, 4, UTC_TIMESTAMP, UTC_TIMESTAMP);
